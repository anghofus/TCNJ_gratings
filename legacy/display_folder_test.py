...
This is (till now 4/2023) not an automatic code. This code will need you to know what you want to do on the film.
...
def open_images():
    ...
    p=0
    while p<m:
        time=(exp_time[p]/768)*20#put your max exposure time here. 
