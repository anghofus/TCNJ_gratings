...
class SawTooth_slider:
    def __init__(self, root):
        ...
        begin_monitor_horizontal = active_monitors[1].x
        begin_monitor_vertical = active_monitors[1].y
        begin_slm_horizontal = active_monitors[0].x
        begin_slm_vertical = active_monitors[0].y
